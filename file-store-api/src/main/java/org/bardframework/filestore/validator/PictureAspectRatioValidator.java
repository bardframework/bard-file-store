...
public class PictureAspectRatioValidator extends SingleFieldValidatorAbstract<FileInfo> {
    ...
    protected boolean isValid(FileInfo value) {
        ...
        try {
            ...
            log.error("error reading image from multi part file. {}", value);
    ...
    private static final class Fraction extends Number implements Comparable<Fraction> {
        ...
        public static Fraction getFraction(String str) {
            AssertionUtils.notNull(str, "The string must not be null");
            // parse double format
            int pos = str.indexOf('.');
            if (pos >= 0) {
        ...
        private Fraction addSub(final Fraction fraction, final boolean isAdd) {
            AssertionUtils.notNull(fraction, "The fraction must not be null");
